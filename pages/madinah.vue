...
const quickActions = [
  { label: 'Ke Masjid Nabawi', icon: Landmark, category: 'Nabawi' as const },
  { label: 'Rawdhah', icon: Flower2, category: 'Rawdhah' as const },
  ...
  { label: 'Ziarah Madinah', icon: MapPinned, category: 'Ziarah' as const },
  ...
  <div class="bg-sht-off-white overflow-x-hidden">
    <section class="pt-28 pb-0 sm:pt-32" aria-labelledby="madinah-opening-heading">
      <div class="mx-auto max-w-container px-5 sm:px-6 lg:px-8">
        ...
        <h1 id="madinah-opening-heading" class="mt-4 max-w-3xl font-hero text-4xl font-bold italic leading-tight text-sht-olive-dark sm:text-5xl break-words">Jelajahi Madinah dari satu tempat.</h1>
