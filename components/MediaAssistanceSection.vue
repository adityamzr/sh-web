...
<template>
  <section id="bantuan" class="bg-sht-olive-dark py-16 text-sht-off-white sm:py-28 overflow-x-hidden" aria-labelledby="assistance-heading">
    <div class="mx-auto max-w-container px-5 sm:px-6 lg:px-8">
      <div class="max-w-2xl">
        ...
        <h2 id="assistance-heading" class="mt-4 font-hero text-4xl font-bold italic leading-tight sm:text-5xl break-words">Ada yang Bisa Kami Bantu?</h2>
        <p class="mt-5 max-w-xl text-base leading-relaxed text-sht-off-white/75 break-words">Jika Anda membutuhkan bantuan perjalanan atau kebutuhan lain di Haramain, kami menyiapkan layanan yang tetap terhubung dengan layanan Sudut Haramain.</p>
      </div>
      ...
      <div class="mt-12 grid gap-5 lg:grid-cols-2 lg:gap-6">
        <div class="group relative min-h-[390px] overflow-hidden rounded-3xl border border-sht-gold/30 bg-sht-olive p-6 sm:p-10">
          <img src="/images/makkah-editorial.jpg" alt="" class="absolute inset-0 h-full w-full object-cover opacity-35 transition-transform duration-700 group-hover:scale-[1.02]" loading="lazy" @error="onImageError" />
          ...
          <div class="relative flex h-full min-h-[330px] flex-col justify-between">
            ...
            <div><h3 class="max-w-xl font-hero text-3xl font-bold not-italic leading-tight text-white sm:text-4xl break-words">Persiapkan perjalanan Umrah dengan lebih tenang.</h3><p class="mt-4 max-w-lg text-sm leading-relaxed text-sht-off-white/75 sm:text-base break-words">Umroh Mandiri &amp; Land Arrangement untuk kebutuhan hotel, transportasi, visa, muthawwif, handling, dan kebutuhan perjalanan lainnya.</p></div>
          </div>
        </div>
        ...
        <div class="min-h-[390px] rounded-3xl border border-sht-off-white/15 bg-sht-olive/45 p-6 sm:p-10">
          ...
          <div class="mt-24 max-w-xl"><h3 class="font-hero text-3xl font-bold not-italic leading-tight text-white sm:text-4xl break-words">Kebutuhan dari Haramain, lebih dekat ke Anda.</h3><p class="mt-4 text-sm leading-relaxed text-sht-off-white/70 sm:text-base break-words">Layanan titip beli dari Makkah–Madinah yang sedang kami siapkan sebagai bagian dari layanan Sudut Haramain.</p></div>
