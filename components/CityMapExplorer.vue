...
<template>
  <section id="makkah-explorer" class="bg-sht-off-white py-12 sm:py-16" aria-labelledby="explorer-heading">
    <div class="mx-auto max-w-container px-5 sm:px-6 lg:px-8">
      <div class="max-w-2xl"><p id="explorer-heading" class="text-xs font-semibold uppercase tracking-[0.22em] text-sht-sage">PETA KOTA</p><p class="mt-3 text-sm leading-relaxed text-sht-charcoal/65">Tempat penting, fasilitas, transportasi, dan titik yang berguna selama berada di Makkah.</p></div>
