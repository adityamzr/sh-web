...
<template>
  <header class="fixed inset-x-0 top-8 z-50 bg-sht-olive-dark py-2 text-sht-off-white transition-[box-shadow] duration-300" :class="isScrolled ? 'shadow-sm' : ''">
